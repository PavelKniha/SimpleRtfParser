...
public enum RtfComands {
	...
	private RtfComands(String commandName, CommandType commandType) {
	 ...
	 */
	public static RtfComands getInstance(String commandName) {
	...
	private static final Map<String, RtfComands> MAP = new HashMap<String, RtfComands>();
	static {
		for (RtfComands command : RtfComands.values()) {
			MAP.put(command.getCommandName(), command);
		}
		MAP.put("\r", RtfComands.par);
		MAP.put("\n", RtfComands.par);
	}
}
